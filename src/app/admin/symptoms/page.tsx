...
import { symptoms as mockSymptoms } from "@/lib/mock-data";
import { Plus, Pencil, Trash2 } from "lucide-react";

const columns: Column<Symptom>[] = [
  { key: "code", header: "Kode", sortable: true },
  { key: "name", header: "Nama Gejala", sortable: true },
...
export default function SymptomsPage() {
  const [data] = useState(mockSymptoms);

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Manajemen Gejala</h1>
          <p className="text-sm text-muted-foreground">
            Kelola data gejala penyakit tanaman cabai.
          </p>
        </div>
