...
export const seedDiseases: SeedDisease[] = [
  { id: "p01", code: "P01", name: "Layu Fusarium", description: "Penyakit ini disebabkan oleh jamur tular tanah yang menginfeksi akar dan jaringan pembuluh (xilem). Gejala awalnya berupa daun yang menguning dan layu pada siang hari. Kondisi ini kemudian berkembang menjadi layu permanen yang dapat menyebabkan kematian tanaman. Apabila batang dipotong, akan terlihat perubahan warna menjadi cokelat pada area pembuluh xilem.", cause: "Fusarium oxysporum f.sp. capsici", solution: "Lakukan pemupukan berimbang (Urea, ZA, TSP, KCl, dan pupuk organik). Gunakan mulsa plastik perak di dataran tinggi atau jerami di dataran rendah. Lakukan pemusnahan (roguing) tanaman sakit sesegera mungkin. Cabut dan musnahkan tanaman terserang. Semprot fungisida sistemik berbahan aktif benomyl atau karbendazim setiap 7 hari. Lakukan solarisasi tanah dengan plastik transparan selama 2-4 minggu.", prevention: "Gunakan varietas tahan Fusarium seperti Lembang-1 atau Tanjung-2. Rotasi tanaman minimal 2-3 tahun dengan bukan famili Solanaceae. Pastikan drainase lahan berfungsi baik, bedengan tinggi 30-40 cm. Sterilkan alat pertanian setelah digunakan. Tambahkan pupuk organik matang dan dolomit untuk meningkatkan pH tanah." },
  { id: "p02", code: "P02", name: "Antraknosa / Patek", description: "Penyakit jamur ini utamanya menyerang buah cabai. Gejalanya ditandai dengan munculnya bercak cekung berwarna cokelat hingga hitam yang terus meluas hingga buah membusuk. Dalam kondisi lembap, permukaan bercak akan menghasilkan massa spora berwarna jingga atau merah muda, sehingga buah menjadi rusak dan tidak layak dikonsumsi.", cause: "Colletotrichum capsici, Colletotrichum acutatum, Colletotrichum gloeosporioides", solution: "Lakukan perendaman benih dalam air panas suhu 55°C selama 30 menit atau fungisida sistemik golongan Triazole. Gunakan ekstrak nabati tanaman marigold (Titonia diversifolata) atau campuran nimba + serai + laos (efikasi setara Mancozeb 0,2%). Petik dan musnahkan semua buah bergejala bercak cekung. Semprot fungisida kontak berbahan aktif mancozeb atau propineb setiap 5-7 hari, selang-seling dengan fungisida sistemik.", prevention: "Gunakan benih sehat yang sudah diberi perlakuan fungisida (seed treatment). Atur jarak tanam 60x70 cm agar sirkulasi udara optimal. Bersihkan sisa tanaman sakit dari musim sebelumnya. Lakukan pemulsaan plastik hitam perak. Panen buah tepat waktu." },
  { id: "p03", code: "P03", name: "Bercak Daun Serkospora", description: "Penyakit ini disebabkan oleh infeksi jamur Cercospora capsici. Gejalanya berupa kemunculan bercak kecil berbentuk bulat hingga tidak beraturan pada daun. Bagian tengah bercak tersebut berwarna abu-abu kecokelatan dengan bagian tepi yang lebih gelap. Serangan yang parah dapat menyebabkan daun menguning, mengering, dan akhirnya gugur, sehingga menurunkan kemampuan fotosintesis tanaman secara drastis.", cause: "Cercospora capsici", solution: "Aplikasikan pestisida nabati berupa ekstrak daun mindi (Melia azederach) dengan konsentrasi 1:20 (berat/volume). Pengendalian kimiawi menggunakan fungisida Difenokonazole (Score 250 EC) dosis 0,5 ml/liter air setiap 7 hari. Pangkas dan kumpulkan daun bergejala bercak coklat. Semprot fungisida secara merata ke permukaan atas dan bawah daun.", prevention: "Jaga kebersihan lahan dari gulma inang alternatif. Atur jarak tanam minimal 50x60 cm. Gunakan mulsa jerami atau plastik cegah percikan tanah. Lakukan pergiliran dengan tanaman bukan inang. Pilih lokasi dengan sirkulasi udara baik." },
  { id: "p04", code: "P04", name: "Layu Bakteri", description: "Penyakit bakteri ini menyerang jaringan pembuluh (xilem) pada tanaman cabai. Gejala awal ditandai dengan tanaman yang layu pada siang hari, meskipun kondisi tanah masih dalam keadaan basah atau lembap. Seiring berjalannya waktu, tanaman akan mengalami layu permanen hingga mati. Ciri khas utama dari infeksi ini adalah keluarnya lendir putih (bacterial ooze) dari pembuluh xilem jika batang dipotong melintang dan direndam di dalam air.", cause: "Ralstonia solanacearum", solution: "Gunakan sterilisasi media semai serta pencabutan tanaman yang terserang agar koloni bakteri tidak menyebar. Lakukan pembukaan naungan persemaian secara bertahap agar tanaman lebih kuat terkena sinar matahari. Segera cabut dan musnahkan tanaman layu (bakar, jangan dikomposkan). Taburkan kapur pertanian pada bekas lubang tanam tanaman sakit. Semprot bakterisida berbahan aktif streptomisin sulfat atau oksitetrasiklin pada tanaman di sekitarnya.", prevention: "Rotasi tanaman minimal 3 tahun dengan tanaman bukan inang (padi, jagung, bawang). Pastikan drainase sempurna, hindari genangan. Gunakan varietas tahan seperti Cabai Keriting Lembang. Sterilkan alat pertanian setelah digunakan. Jangan gunakan air irigasi dari lahan terinfeksi." },
  { id: "p05", code: "P05", name: "Virus Kuning / Gemini", description: "Penyakit virus ini merupakan salah satu penyakit utama pada cabai di Indonesia yang menyebar melalui perantara serangga kutu kebul (Bemisia tabaci). Infeksi ini menyebabkan daun menguning, menggulung ke atas, dan tulang daun menebal. Selain itu, penyakit ini juga membuat ruas batang memendek, tanaman tumbuh kerdil, serta produksi buah menurun tajam.", cause: "Pepper Yellow Leaf Curl Virus (PepYLCIV/PYLCV), genus Begomovirus, famili Geminiviridae (ditularkan oleh kutu kebul / Bemisia tabaci)", solution: "Gunakan mulsa plastik perak untuk menghalangi vektor kutu kebul (Bemisia tabaci). Lepaskan parasitoid Encarcia formosa (1 ekor/4 tanaman) atau predator Menochilus sexmaculatus. Jika terpaksa, semprot vektor dengan insektisida berbahan aktif Imidakloprid atau Bifentrin. Cabut dan musnahkan tanaman yang sudah terinfeksi berat. Pasang perangkap kuning (yellow sticky trap) 40-60 lembar per hektar.", prevention: "Gunakan benih sehat dari sumber terpercaya. Pasang perangkap kuning sejak awal tanam. Tanam tanaman penghalang (barrier crop) jagung atau sorgum di sekeliling lahan. Gunakan mulsa plastik perak yang memantulkan cahaya. Lakukan tanam serempak dalam satu kawasan." },
  { id: "p06", code: "P06", name: "Bengkak Akar", description: "Penyakit ini disebabkan oleh nematoda puru akar yang menginfeksi sistem perakaran dan membentuk benjolan atau puru (gall). Infeksi tersebut secara langsung menghambat proses penyerapan air dan unsur hara dari tanah. Akibatnya, tanaman menjadi kerdil, daun tampak menguning, mudah layu di siang hari, serta mengalami penurunan hasil panen.", cause: "Meloidogyne spp. (terutama Meloidogyne incognita dan M. javanica)", solution: "Hindari penggunaan lahan yang sudah terkontaminasi bengkak akar. Lakukan pembalikan tanah agar terkena paparan sinar matahari; lakukan perendaman lahan selama 2-3 hari. Aplikasikan Furadan dengan dosis 30 kg/ha pada area terinfeksi. Cabut tanaman bergejala kerdil dan periksa akar untuk konfirmasi puru. Tambahkan bahan organik berupa kompos atau pupuk kandang matang 20-30 ton/ha.", prevention: "Rotasi tanaman dengan tanaman anti-nematoda seperti tagetes (marigold) atau sawi selama 1-2 musim. Gunakan bibit sehat dengan akar bebas puru. Bajak tanah dalam-dalam saat musim kemarau. Rendam akar bibit dalam larutan nematisida sebelum tanam. Pertahankan kandungan bahan organik tanah di atas 3%." },
  { id: "p07", code: "P07", name: "Busuk Fitoftora", description: "Patogen penyebab penyakit ini menyerang seluruh bagian tanaman cabai, mulai dari akar, pangkal batang, daun, hingga buah. Gejala yang ditimbulkan berupa pembusukan berwarna cokelat kehitaman yang mampu menyebar dengan cepat apabila berada dalam kondisi kelembapan tinggi. Serangan berat pada akhirnya akan mengakibatkan tanaman menjadi layu, roboh, dan mati.", cause: "Phytophthora capsici", solution: "Kendalikan secara kimiawi menggunakan fungisida sistemik Metalaksil-M 4% + Mancozeb 64% (Ridomil Gold) konsentrasi 3 g/liter air. Lakukan rotasi penyemprotan secara bergantian dengan fungisida kontak seperti klorotalonil (Daconil 500 F). Pangkas dan musnahkan bagian tanaman terserang busuk. Hentikan penyiraman sementara jika kelembaban tanah tinggi. Taburkan kapur pertanian di sekitar pangkal batang.", prevention: "Tinggikan bedengan minimal 40-50 cm, terutama di musim hujan. Gunakan mulsa plastik cegah kontak tanaman dengan tanah. Atur jarak tanam lebar (70x70 cm). Pastikan saluran drainase antar bedengan berfungsi baik. Siram tanaman pada pagi hari." },
  { id: "p08", code: "P08", name: "Penyakit Kerupuk", description: "Penyakit ini ditandai dengan daun muda yang berubah menjadi keriting, berkerut, dan menebal. Permukaan daun akan terlihat bergelombang menyerupai tekstur kerupuk dengan tulang daun yang semakin menonjol. Kondisi ini menyebabkan tanaman menjadi kerdil dan gagal berbuah secara optimal. Gejala dapat muncul lebih parah jika tanaman terinfeksi oleh campuran dari beberapa jenis virus sekaligus.", cause: "Chilli veinal mottle virus (ChiVMV), sering ditemukan bersama Cucumber mosaic virus (CMV) atau Begomovirus", solution: "Lakukan pemusnahan tanaman muda yang bergejala melengkung/keriput sebelum umur maksimal 35 hari. Kendalikan vektor kutu daun (Aphis gossypii) menggunakan aplikasi insektisida dengan nozel spuyer kipas guna menghemat volume semprot hingga 30%. Semprot insektisida sistemik berbahan aktif Imidakloprid atau Asetamiprid. Lakukan pengendalian vektor secara intensif setiap 3-5 hari.", prevention: "Gunakan benih sehat bersertifikat dari penangkar resmi. Lakukan sanitasi lingkungan, bersihkan gulma sekitar lahan. Kendalikan serangga vektor sejak awal tanam dengan insektisida sistemik. Pasang perangkap serangga untuk monitoring. Lakukan tanam serempak dengan petani sekitar." },
  { id: "p09", code: "P09", name: "Rebah Kecambah", description: "Penyakit ini rentan menyerang benih dan bibit cabai yang masih berada pada fase persemaian. Pembusukan terjadi pada area pangkal batang, sehingga menyebabkan bibit menjadi rebah, layu, lalu mati. Jamur patogen penyakit ini akan berkembang sangat pesat pada media tanam yang terlalu basah, bersistem drainase buruk, dan memiliki sirkulasi udara yang rendah.", cause: "Pythium spp., Rhizoctonia solani, Phytophthora spp., dan kadang Fusarium spp.", solution: "Gunakan lapisan sub-soil (1,5-2 meter di bawah permukaan tanah) yang dipasteurisasi selama 2 jam untuk media semai. Semaian yang terinfeksi harus dicabut dan dimusnahkan. Segera buang bibit yang sudah rebah atau menunjukkan gejala busuk batang. Semprot bibit dengan fungisida berbahan aktif benomil atau propamokarb 2 kali seminggu. Kurangi frekuensi dan volume penyiraman, jaga media semai tetap lembab tidak basah.", prevention: "Sterilkan media semai dengan mengukus atau menjemur 3-5 hari di bawah sinar matahari langsung. Gunakan benih sehat dengan perlakuan fungisida (seed treatment). Atur kelembaban persemaian: siram pagi hari, ventilasi cukup. Gunakan tray semai dengan drainase baik, jangan gunakan tanah kebun langsung. Semprot bibit dengan fungisida preventif seminggu sekali sejak umur 7 hari." },
  { id: "p10", code: "P10", name: "Embun Tepung", description: "Gejala utama yang ditimbulkan oleh penyakit ini adalah munculnya lapisan putih menyerupai bedak atau tepung pada permukaan daun, khususnya di bagian bawah helaian daun. Daun yang telah terinfeksi selanjutnya akan mengalami klorosis (menguning), mengering, lalu gugur. Hal ini berdampak buruk terhadap berkurangnya luas permukaan daun untuk berfotosintesis yang ujungnya menurunkan kuantitas dan kualitas hasil panen.", cause: "Leveillula taurica", solution: "Lakukan pemupukan berimbang secara ketat dan hindari pemberian nitrogen berlebih. Semprot dengan fungisida Difenokonazole (Score 250 EC) dosis 0,5 ml/liter dengan butiran kabut nozel kipas secara merata. Aplikasikan pada sore hari untuk hindari daun terbakar. Pangkas daun yang sudah tertutup lapisan tepung secara merata. Alternatif: gunakan fungisida nabati dari larutan susu skim 10% atau baking soda 1 sdm/liter air.", prevention: "Jaga sirkulasi udara antar tanaman dengan jarak tanam cukup (minimal 60 cm). Atur pemangkasan daun tua dan cabang bawah secara rutin. Hindari pemupukan nitrogen berlebihan. Tambahkan pupuk kalium untuk perkuat ketahanan jaringan daun. Lakukan penyiraman pagi hari dan hindari berlebihan." },
  { id: "p11", code: "P11", name: "Busuk Basah Buah", description: "Penyakit akibat bakteri ini mengakibatkan buah cabai berubah menjadi lunak, berair, berlendir, dan memunculkan bau busuk yang menyengat. Infeksi biasanya bermula melalui celah luka pada permukaan buah yang disebabkan oleh berbagai faktor, seperti gesekan, gigitan serangga hama, maupun kerusakan mekanis lainnya. Setelah masuk, bakteri pembusuk ini akan menyebar dengan sangat cepat di lingkungan berkelembapan tinggi.", cause: "Pectobacterium carotovorum subsp. carotovorum (sin. Erwinia carotovora)", solution: "Atur jarak tanam agar tidak terlalu rapat demi menjaga sirkulasi udara kebun. Lakukan pemanenan buah hanya pada kondisi cuaca kering dan tambahkan klorin pada air pencuci buah cabai untuk mencegah memar/luka. Petik dan musnahkan semua buah bergejala busuk basah. Semprot bakterisida berbahan aktif streptomisin atau oksitetrasiklin. Kurangi kelembaban dengan memangkas cabang terlalu rimbun.", prevention: "Hindari pelukaan buah saat pemanenan, penyiangan, atau pengendalian hama. Panen buah tepat waktu, jangan menunda terlalu lama. Jaga sanitasi kebun, bersihkan buah busuk yang jatuh. Gunakan mulsa plastik cegah percikan tanah. Atur jarak tanam cukup lebar (60x70 cm) dan pastikan drainase lahan baik." },
];
