...
export const diseases: Disease[] = [
  ...
  },
  {
    ...
    description: "Penyakit ini disebabkan oleh infeksi jamur Cercospora capsici. Gejalanya berupa kemunculan bercak kecil berbentuk bulat hingga tidak beraturan pada daun. Bagian tengah bercak tersebut berwarna abu-abu kecokelatan dengan bagian tepi yang lebih gelap. Serangan yang parah dapat menyebabkan daun menguning, mengering, dan akhirnya gugur, sehingga menurunkan kemampuan fotosintesis tanaman secara drastis.",
  ...
  },
  {
    ...
    code: "P04",
    name: "Layu Bakteri",
    description: "Penyakit bakteri ini menyerang jaringan pembuluh (xilem) pada tanaman cabai. Gejala awal ditandai dengan tanaman yang layu pada siang hari, meskipun kondisi tanah masih dalam keadaan basah atau lembap. Seiring berjalannya waktu, tanaman akan mengalami layu permanen hingga mati. Ciri khas utama dari infeksi ini adalah keluarnya lendir putih (bacterial ooze) dari pembuluh xilem jika batang dipotong melintang dan direndam di dalam air.",
  ...
  },
  {
    ...
    description: "Penyakit virus ini merupakan salah satu penyakit utama pada cabai di Indonesia yang menyebar melalui perantara serangga kutu kebul (Bemisia tabaci). Infeksi ini menyebabkan daun menguning, menggulung ke atas, dan tulang daun menebal. Selain itu, penyakit ini juga membuat ruas batang memendek, tanaman tumbuh kerdil, serta produksi buah menurun tajam.",
    cause: "Pepper Yellow Leaf Curl Virus (PepYLCIV/PYLCV), genus Begomovirus, famili Geminiviridae (ditularkan oleh kutu kebul / Bemisia tabaci)",
  ...
  },
  {
    ...
    description: "Penyakit ini ditandai dengan daun muda yang berubah menjadi keriting, berkerut, dan menebal. Permukaan daun akan terlihat bergelombang menyerupai tekstur kerupuk dengan tulang daun yang semakin menonjol. Kondisi ini menyebabkan tanaman menjadi kerdil dan gagal berbuah secara optimal. Gejala dapat muncul lebih parah jika tanaman terinfeksi oleh campuran dari beberapa jenis virus sekaligus.",
    cause: "Chilli veinal mottle virus (ChiVMV), sering ditemukan bersama Cucumber mosaic virus (CMV) atau Begomovirus",
  ...
  },
  {
    ...
    cause: "Pythium spp., Rhizoctonia solani, Phytophthora spp., dan kadang Fusarium spp.",
  ...
  },
  {
    ...
    code: "P10",
    name: "Embun Tepung",
    description: "Gejala utama yang ditimbulkan oleh penyakit ini adalah munculnya lapisan putih menyerupai bedak atau tepung pada permukaan daun, khususnya di bagian bawah helaian daun. Daun yang telah terinfeksi selanjutnya akan mengalami klorosis (menguning), mengering, lalu gugur. Hal ini berdampak buruk terhadap berkurangnya luas permukaan daun untuk berfotosintesis yang ujungnya menurunkan kuantitas dan kualitas hasil panen.",
  ...
  },
  {
    ...
    description: "Penyakit akibat bakteri ini mengakibatkan buah cabai berubah menjadi lunak, berair, berlendir, dan memunculkan bau busuk yang menyengat. Infeksi biasanya bermula melalui celah luka pada permukaan buah yang disebabkan oleh berbagai faktor, seperti gesekan, gigitan serangga hama, maupun kerusakan mekanis lainnya. Setelah masuk, bakteri pembusuk ini akan menyebar dengan sangat cepat di lingkungan berkelembapan tinggi.",
    cause: "Pectobacterium carotovorum subsp. carotovorum (sin. Erwinia carotovora)",
